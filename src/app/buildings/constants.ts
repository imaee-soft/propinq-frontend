export const BUILDING_CREATED_MESSAGE = 'El edificio fue creado con éxito!';
export const BUILDING_CREATION_ERROR_MESSAGE = 'Error al crear el edificio';
export const BUILDING_ICON_URL = '/building.png';
